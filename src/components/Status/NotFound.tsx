...
const NotFound: FC = () => {
    return (
        <>
            <Page
                banner={ <Banner title="Not Found" subtitle="Maybe this page was removed?" /> }
            >
                <div style={{paddingLeft: 30}}>
                <p>
                    Unfortunately, this page does not exist. The reason for this can be anything:
                    maybe I forgot to update a link somewhere, or I referenced a page I haven't created
                    yet (at least in this version of the portfolio), perhaps I mistyped a link.
                </p>
                <p>
                    Anyway, below is the whole script for Bee Movie:
                </p>

        ...
        <div id="about">
            <section id="me" className="about-section odd-section">
                <div className="about-section-content">
                    ...
                    <div className="about-text">
                        ...
                        <p>Hello, I'm <strong>David Rosental</strong>, a computer science student at the <strong>University of Warwick</strong>. I started in September 2023, so I am in my 2nd year of my <a href="https://warwick.ac.uk/fac/sci/dcs/teaching/courses/"><strong>4 year MEng course</strong></a>.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="skills" className="about-section odd-section">
                <div className="about-section-content">
                    ...
                    <div className="about-text">
                        <p><u>Languages:</u> <strong>Python</strong> (<i>intermediate</i>), <strong>Java</strong> (<i>intermediate</i>), <strong>C#</strong> (<i>intermediate</i>), <strong>Javascript/Typescript</strong> (<i>intermediate</i>), <strong>C</strong>/<strong>C++</strong> (<i>beginner</i>), <strong>HTML</strong>/<strong>CSS</strong>/<strong>JS</strong> (<i>beginner</i>)</p>
                        <p><u>Frameworks:</u> <strong>ASP.NET Core</strong> (<i>intermediate</i>), <strong>ReactJS</strong> (<i>beginner</i>), <strong>Flask</strong> (<i>beginner</i>), <strong>jQuery</strong> (<i>beginner</i>)</p>
